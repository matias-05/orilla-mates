            ...
            <nav className="flex flex-wrap justify-center gap-3">
                {categoriasNav.map((cat) => (
                    <NavLink
                        ...
                        to={cat.path}
                        className={({ isActive }) => `
                            px-5 py-2 rounded-full text-sm font-bold tracking-widest uppercase transition-all duration-300 border border-[#2F4A2F]
                            ${isActive 
                                ? 'bg-[#2F4A2F] text-[#F2E4C9] shadow-lg scale-105'
